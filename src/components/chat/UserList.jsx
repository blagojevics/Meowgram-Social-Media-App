...
const UserList = ({ onClose, onStartChat }) => {
  ...
  useEffect(() => {
    ...
    const availableUsers = chatUsers.filter(
      (user) => user._id !== chatUser._id && user.id !== chatUser.id
    );
          ...
          {loading ? (
            ...
            <div className="users-list">
              {filteredUsers.map((user) => {
                const isOnline = isUserOnline(user._id || user.id);
                  ...
                  >
                    <div className="user-avatar">
                      <img
                        ...
                        alt={user.username || user.displayName || user.email}
                      />
